...
<div class="main-content p-4" id="panel">
    <div class="card">
        ...
        <div class="card-body">
        <form action="{{ route('room_types.store') }}" method="post" enctype="multipart/form-data"><input type="hidden" >
            @csrf
        ...
        <input type="text" class="form-control form-control-lg" name="title" placeholder="Floor name" required>
        </div>

        <div class="form-group col-md-6">
        <label><strong>Short Code</strong> <small class="text-danger">*</small></label>
        <input type="text" class="form-control form-control-lg" name="short_code" placeholder="Short Code" value="" required>
        </div>
        </div>
        ...
        <div class="form-row justify-content-center">
            ...
            <input type="number" class="form-control form-control-lg" name="higher_capacity" placeholder="Max Capacity" required>
            </div>
    
            <div class="form-group col-md-4">
            <label><strong>Kids Capacity</strong> <small class="text-danger">*</small></label>
            <input type="number" class="form-control form-control-lg" name="kids_capacity" placeholder="Kids Capacity" value="" required>
            </div>

            <div class="form-group col-md-4">
                <label><strong>Base Price</strong> <small class="text-danger">*</small></label>
                <input type="number" class="form-control form-control-lg" name="base_price" placeholder="Base Price" value="" required>
                </div>
            </div>
