...
<div class="main-content p-4" id="panel">
    <div class="card">
        ...
        <a class="btn btn-tsk float-right" href="{{ route('paid_services.index') }}"><i class="fa fa-list"></i> Floor List</a>
        </h2>
        </div>


        <div class="card-body">
        <form action="{{ route('paid_services.store') }}" method="post" enctype="multipart/form-data"><input type="hidden" >
            @csrf
        ...
        <input type="number" class="form-control form-control-lg" name="price" placeholder="Price" value="" required>
        </div>
        </div>
        ...
        <textarea class="form-control form-control-lg" rows="4" name="short_desc" placeholder="Description"></textarea>
        </div>
        </div>
