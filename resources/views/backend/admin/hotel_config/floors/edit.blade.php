...
<div class="main-content p-4" id="panel">
    ...
    <div class="card">
        <div class="card-header bg-white">
            <h2>Create Floor
                <a class="btn btn-tsk float-right" href="{{ route('floors.index') }}"><i class="fa fa-list"></i> Floor
                    List</a>
            </h2>
        </div>
        ...
        <div class="card-body">
            <form action="{{ route('floors.update', $floor->id) }}" method="post" enctype="multipart/form-data"><input
                    type="hidden">
                @csrf
                @method('PUT')
                ...
                <div class="form-row justify-content-center">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control form-control-lg" name="name" placeholder="Floor name"
                            value="{{ $floor->name}}" required>
                    </div>

                    <div class="form-group col-md-6">
                        <label><strong>Number</strong> <small class="text-danger">*</small></label>
                        <input type="text" class="form-control form-control-lg" name="number" placeholder="Number"
                ...
                <div class="form-row justify-content-center">
                    <div class="form-group col-md-12">
                        ...
                        <textarea class="form-control form-control-lg" rows="4" name="description"
                            placeholder="Description">{{ $floor->description}}</textarea>
                    </div>
                </div>
