...
<div class="main-content p-4" id="panel">
    <div class="card">
        ...
        <div class="card-body">
        <form action="{{ route('floors.update', $floor->id) }}" method="post" enctype="multipart/form-data"><input type="hidden" >
            @csrf
            @method('PUT')
        ...
        <input type="text" class="form-control form-control-lg" name="name" placeholder="Floor name" value="{{ $floor->name}}" required>
        </div>
