...
<div class="main-content p-4" id="panel">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <form action="{{ route('rooms.update', $room->id) }}" method="post" enctype="multipart/form-data"><input
          type="hidden">
        @csrf
        @method('PUT')
        ...
        <div class="form-row justify-content-center">
          <div class="form-group col-md-12">
            ...
            <input value="{{$room->number}}" type="text" class="form-control form-control-lg" name="number"
        ...
        <div class="form-row justify-content-center">
          ...
          <div class="form-group col-md-6">
            ...
            <select value="{{$room->room_type_id}}" name="room_type_id" class="form-control"
        ...
        <div class="form-row justify-content-center">
          ...
          <div class="form-group col-md-12">
            ...
            <div class="custom-file">
              <input value="{{$room->image}}" type="file" name="image" class="custom-file-input" id="customFileLang"
                lang="en" enctype="multipart/form-data">
        ...
        <div class="form-row justify-content-center">
          <div class="form-group col-sm-12">
            ...
            <label class="custom-toggle">
              <input value="{{$room->status}}" id="status" checked type="checkbox" data-onstyle="success"
