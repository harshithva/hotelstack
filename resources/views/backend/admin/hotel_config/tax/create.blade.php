            ...
            <form action="{{ route('tax.store') }}" method="post" enctype="multipart/form-data"><input type="hidden">
                ...
                <div class="form-row justify-content-center">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control form-control-lg" name="name" placeholder="Tax Name"
                            required>
                    </div>
                ...
                <div class="form-row justify-content-left">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="number" class="form-control form-control-lg" name="amount_1"
                            placeholder="Enter Amount" required>
                    </div>

                    <div class="form-group col-md-4">
                        <label><strong>Rate (percent)</strong> <small class="text-danger">*</small></label>
                        <input type="number" class="form-control form-control-lg" name="rate_1" placeholder="Percentage"
                            required>
                    </div>
                ...
                <div class="form-row justify-content-left">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="number" class="form-control form-control-lg" name="amount_2"
                            placeholder="Enter Amount">
                    </div>

                    <div class="form-group col-md-4">
                        <label><strong>Rate (percent)</strong></label>
                        <input type="number" class="form-control form-control-lg" name="rate_2"
