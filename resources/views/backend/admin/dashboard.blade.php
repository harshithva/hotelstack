...
<div class="main-content" id="panel">
              ...
              <div class="list-group list-group-flush">
                <a href="#!" class="list-group-item list-group-item-action">
                  <div class="row align-items-center">
                    <div class="col-auto">
                      <!-- Avatar -->
                      <img alt="Image placeholder" src="./backend/assets/img/theme/team-1.jpg"
                ...
                <a href="#!" class="list-group-item list-group-item-action">
                  <div class="row align-items-center">
                    <div class="col-auto">
                      <!-- Avatar -->
                      <img alt="Image placeholder" src="./backend/assets/img/theme/team-2.jpg"
                        class="avatar rounded-circle">
                    </div>
                    <div class="col ml--2">
                      <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="#!" class="list-group-item list-group-item-action">
                  <div class="row align-items-center">
                    <div class="col-auto">
                      <!-- Avatar -->
                      <img alt="Image placeholder" src="./backend/assets/img/theme/team-3.jpg"
                        class="avatar rounded-circle">
                    </div>
                    <div class="col ml--2">
                      <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="#!" class="list-group-item list-group-item-action">
                  <div class="row align-items-center">
                    <div class="col-auto">
                      <!-- Avatar -->
                      <img alt="Image placeholder" src="./backend/assets/img/theme/team-5.jpg"
                        class="avatar rounded-circle">
                    </div>
                    <div class="col ml--2">
                      <div class="d-flex justify-content-between align-items-center">
  ...
  <div class="row p-4 d-flex justify-content-start">
    <div class="mr-2 ml-4">
      <a type="button" class="btn btn-primary" href="{{route('checkin.create')}}">Check in</a>
    </div>
    <div class="mr-2 ml-4">
      <a type="button" class="btn btn-default" href="{{route('reservations.create')}}">Reserve</a>
    </div>
    <div class="mr-2 ml-4">
      <a type="button" class="btn btn-danger" href="{{route('guests.create')}}">Add Guest</a>
    </div>
    <div class="mr-2 ml-4">
      <a type="button" class="btn btn-info" href="{{route('rooms.create')}}">Add Room</a>
    </div>
    <div class="mr-2 ml-4">
      <a type="button" class="btn btn-warning" href="{{route('floors.create')}}">Add Floor</a>
    </div>
