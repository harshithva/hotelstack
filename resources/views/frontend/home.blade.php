	...
	<section class="intro">
		<div class="intro__bg-wrap">
			<div class="overlay intro__bg js-image js-parallax"
				data-image="/storage/cover_images/{{$home->banner_image}}"></div>
		</div>
		<div class="container intro__container">
			<div class="row h-100 align-items-center">
				<div class="col-12 col-md-12 col-xl-8">
					...
					<button class="intro__btn-play js-lines" id="play">Adventure<span
							class="btn-play btn-play__popup"></span></button>
				</div>
			</div>
		</div>
		<!-- Scroll To -->
		...
		<form class="bottom-panel__wrap d-flex">
			<div class="row bottom-panel__form-wrap">
				<div class="form-group col-date-to col-12 col-sm-6 col-md-4 slash">
					...
					<input type="text" class="inputFeature input-arrow readonly js-datepicker" id="check-in"
						name="check-in" placeholder="Select date" required="required" autocomplete="off">
				</div>
				<div class="form-group col-date-from col-12 col-sm-6 col-md-4 slash">
					<label class="labelFeature" for="check-out">Check out</label>
					<input type="text" class="inputFeature input-arrow readonly js-datepicker" id="check-out"
						name="check-out" placeholder="Select date" required="required" autocomplete="off">
				</div>
				<div class="form-group col-12 col-md-4 dropdown">
					<div class="closeDropdown" id="dropdownPersonsAction" data-toggle="dropdown" data-display="static">
						...
						<input type="text" class="inputFeature input-arrow readonly" id="person-total" name="person"
							placeholder="Select person" required="required" autocomplete="off">
					</div>

					<!-- Dropdown person -->
					<div class="dropdown-menu dropdown-menu-lg-left dropdown-menu-right" id="dropdownPersons"
						...
						<div class="row">
							<div class="form-group col-6 col__left">
								...
								<div class="js-quantity">
									...
									<input type="number" class="inputText js-quantity-input" id="person-adult"
										name="person-adalt" value="0" min="1" max="8" readonly="readonly">
							...
							<div class="form-group col-6 col__right">
								...
								<div class="js-quantity">
									<span class="qty-minus icon-minus"></span>
									<input type="number" class="inputText js-quantity-input" id="person-kids"
										name="person-kids" value="0" min="0" max="8" readonly="readonly">
									<span class="qty-plus icon-plus"></span>
								</div>
							</div>
						</div>
						<div class="row row-footer">
							<div class="col-6 col__left">
								<button type="button"
									class="btn btn__small btn__second btn-reset-persons w-100">Clear</button>
							</div>
		...
		<div class="row">
			...
			<div class="col-12 col-lg-6">
				<figure class="about-image-wrap mr-0 mr-lg-4">
					...
					<img class="cover about-image-portrait"
						src="{{ asset('./frontend/assets/images/about_image_01.jpg') }}" alt="about" />
				</figure>
			</div>
			<div class="col-12 col-lg-6">
				<figure class="about-image-wrap ml-0 ml-lg-4">
					<img class="cover about-image-landscape"
						src="{{ asset('./frontend/assets/images/about_image_02.jpg') }}" alt="about" />
				</figure>
			</div>
		</div>
	</section>
		...
		<div class="row">
				...
				<div class="itemRoom">
					...
					<figure class="itemRoom__img-wrap">
						<a class="itemRoom__link" href="room_details.html">
							<img class="cover" src="{{ asset('./frontend/assets/images/image_room_01.jpg') }}"
								alt="room" />
						</a>
					</figure>
			...
			<div class="col-12 col-md-6 col-lg-4">
				...
				<div class="itemRoom">
					<figure class="itemRoom__img-wrap">
						<a class="itemRoom__link" href="room_details.html">
							<img class="cover" src="{{ asset('./frontend/assets/images/image_room_02.jpg') }}"
								alt="room" />
						</a>
					</figure>
					<div class="itemRoom__details">
			...
			<div class="col-12 col-md-6 col-lg-4">
				...
				<div class="itemRoom">
					<figure class="itemRoom__img-wrap">
						<a class="itemRoom__link" href="room_details.html">
							<img class="cover" src="{{ asset('./frontend/assets/images/image_room_03.jpg') }}"
								alt="room" />
						</a>
					</figure>
					<div class="itemRoom__details">
			...
			<div class="col-12 col-md-6 col-lg-4">
				...
				<div class="itemRoom">
					<figure class="itemRoom__img-wrap">
						<a class="itemRoom__link" href="room_details.html">
							<img class="cover" src="{{ asset('./frontend/assets/images/image_room_04.jpg') }}"
								alt="room" />
						</a>
					</figure>
					<div class="itemRoom__details">
			...
			<div class="col-12 col-md-6 col-lg-4">
				...
				<div class="itemRoom mb-0">
					<figure class="itemRoom__img-wrap">
						<a class="itemRoom__link" href="room_details.html">
							<img class="cover" src="{{ asset('./frontend/assets/images/image_room_05.jpg') }}"
								alt="room" />
						</a>
					</figure>
					<div class="itemRoom__details">
	...
	<section class="container section">
		<div class="row">
			<div class="col-12 col-lg-7">
				<h2 class="title-description js-lines">We strive to be the best in our field to make you even more
					comfortable.</h2>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-12">
					...
					<h1 class="title title--h1 js-lines">What clients <br><span class="text-accent">say about us.</span>
					</h1>
				</div>
					...
					<div class="swiper-container js-testimonials mb-5">
						<div class="swiper-wrapper">
							...
							<div class="testimonials-item swiper-slide">
								...
								<p class="testimonials-item__caption">— The hotel has everything you need. On the ground
								...
								<div class="author-wrap">
									<div class="author-picture"><img class="cover"
											src="{{ asset('./frontend/assets/images/person.jpg')}}" alt="Jacob Lane" />
									</div>
									<div>
							...
							<div class="testimonials-item swiper-slide">
								...
								<p class="testimonials-item__caption">— Well, what can I say, every year, day and hour,
									this place is being transformed for the better. The staff is completely competent
									and friendly, Everything around is blooming, pleasing, nourishing and making the
									holiday bright.</p>
								<div class="author-wrap">
									<div class="author-picture"><img class="cover"
											src="{{ asset('./frontend/assets/images/person2.jpg')}}"
											alt="Victoria Wilson" /></div>
									<div>
							...
							<div class="testimonials-item swiper-slide">
								...
								<p class="testimonials-item__caption">— The modern 5 * Hotel"HotelPlex Center is an
									ideal solution for combining business and leisure. Stylish design and exceptional
									service will satisfy the desires of any guest. 150 rooms with balcony (non-smoking),
									sea view, trendy restaurant.</p>
								<div class="author-wrap">
									<div class="author-picture"><img class="cover"
											src="{{ asset('./frontend/assets/images/person3.jpg')}}"
											alt="Max Edwards" /></div>
									<div>
	...
	<section class="container">
		<div class="row cta-box cta-negative js-scroll-show">
			<div class="col-12 col-lg-7">
				...
				<p class="paragraph">Book your room right now and start your amazing adventure full of discoveries and
					experiences with"HotelPlex.</p>
			</div>
			<div class="col-12 col-lg-5 text-lg-right">
				<a href="rooms.html" class="btn btn__large btn--white">Reservations <i
						class="btn-icon-right icon-arrow-special"></i></a>
			</div>
		</div>
	</section>
</main>
